...
RSpec.describe 'admin merchants index' do
  ...
  describe 'userstory 30' do 
    ...
    Revenue for an invoice item should be calculated as the invoice item unit price multiplied by the quantity (do not use the item unit price)" do
      ...
      expect(page).to have_content(merchant1.total_revenue.to_f/100)
      expect(page).to have_content(merchant2.total_revenue.to_f/100)
      expect(page).to have_content(merchant3.total_revenue.to_f/100)
      expect(page).to have_content(merchant4.total_revenue.to_f/100)
      expect(page).to have_content(merchant5.total_revenue.to_f/100)
    end
  end
